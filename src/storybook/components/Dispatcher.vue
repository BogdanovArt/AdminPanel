...
export default class InputExpandableGroup extends Vue {
  ...
  @Prop() readonly rules!: string | undefined;
  @Prop() readonly mask!: IValidation;
  ...
  @Prop() readonly inputType!: string | undefined;
  @Prop() readonly value!: string | undefined;
  @Prop() readonly checked!: string | undefined;
  ...
  get item() {
    return {
      ...
      errorMsg: this.errors?.data && this.errors.data[this.name],
    };
  }
